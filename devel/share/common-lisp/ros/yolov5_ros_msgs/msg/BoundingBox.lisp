...
(cl:defmethod center_x-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolov5_ros_msgs-msg:center_x-val is deprecated.  Use yolov5_ros_msgs-msg:center_x instead.")
  (center_x m))

(cl:ensure-generic-function 'center_y-val :lambda-list '(m))
(cl:defmethod center_y-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolov5_ros_msgs-msg:center_y-val is deprecated.  Use yolov5_ros_msgs-msg:center_y instead.")
  (center_y m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<BoundingBox>)))
  ...
  "7537cfbd43c7ae2b3095fb064f0dc1c6")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'BoundingBox)))
  "Returns md5sum for a message object of type 'BoundingBox"
  "7537cfbd43c7ae2b3095fb064f0dc1c6")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<BoundingBox>)))
  ...
  (cl:format cl:nil "float64 probability~%int64 xmin~%int64 ymin~%int64 xmax~%int64 ymax~%int16 num~%string Class~%int64 center_x~%int64 center_y~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'BoundingBox)))
  "Returns full string definition for message of type 'BoundingBox"
  (cl:format cl:nil "float64 probability~%int64 xmin~%int64 ymin~%int64 xmax~%int64 ymax~%int16 num~%string Class~%int64 center_x~%int64 center_y~%~%"))
